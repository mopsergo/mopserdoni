...
class OfferForm(FlaskForm):
    ...
    anteilgr = SelectField('Ein, halber oder mehr Gemüseanteil(e)?', choices=[(1, '1 Gemüseanteil'), (0.5, '1/2 Gemüseanteil'), (2, '2 Gemüseanteile'), (3, '3 Gemüseanteile'),(4, '4 Gemüseanteile'), (0, 'Kein Gemüse'),], coerce=float, validators=[InputRequired()])
    brot = SelectField('Kein, halber, ein oder mehr Brotanteil(e)?', choices=[(0, 'Kein Brotanteil'), (0.5, '1/2 Brotanteil'), (1.5, '1-1/2 Brotanteil'), (1, '1 Brotanteil'), (2, '2 Brotanteile'),(3, '3 Brotanteile'),(4, '4 Brotanteile')], coerce=float, validators=[InputRequired()])
